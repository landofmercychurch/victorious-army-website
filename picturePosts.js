  ...
  try {
    ...
    posts.forEach(post => {
      ...
      commentBtn.addEventListener("click", () => {
        ...
        if (isOpen) {
          stopAutoplay(); // pause autoplay while reading comments
          loadComments();
        } else {
          startAutoplay(); // resume autoplay when comments closed
        }
      });
    });
    ...
    if (isMobile) {
      ...
      container.addEventListener("touchstart", e => {
        ...
        stopAutoplay(); // pause during swipe
      });
      ...
      // Desktop just shows all posts as grid
